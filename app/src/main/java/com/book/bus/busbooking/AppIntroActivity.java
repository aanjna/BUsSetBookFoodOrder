...
public class AppIntroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        skip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                endTutorial();
                Intent i = new Intent(AppIntroActivity.this, BusServices.class);
                startActivity(i);
                finish();
            }
        });
        ...
        pager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                if (position == NUM_PAGES - 1 && positionOffset > 0) {//change hre
                    if (isOpaque) {
    ...
    private class ScreenSlidePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            AppIntroFragment tp = null;
            switch(position){
                case 0:
                    tp = AppIntroFragment.newInstance(R.layout.welcome_fragment1);
                    break;
                case 1:
                    tp = AppIntroFragment.newInstance(R.layout.welcome_fragment2);
                    break;
                case 2:
                    tp = AppIntroFragment.newInstance(R.layout.welcome_fragment3);
                    break;
                case 3:
                    tp = AppIntroFragment.newInstance(R.layout.welcome_fragment4);
                    break;
            }
